...
export default function ThemeSwitchButton() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="theme-switch group relative flex items-center justify-center w-9 h-9 rounded-full font-medium text-sm shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-transparent focus:ring-white/20"
